...
export type HistoryNodeReference =
  components["schemas"]["HistoryNodeReference"];
export type HistoryNodes = components["schemas"]["HistoryNodes"];
export type HistoryEdgeSummary = components["schemas"]["HistoryEdgeSummary"];
...
export type DirectorySyncState = components["schemas"]["DirectorySyncState"];
export type MetadataConflict = components["schemas"]["MetadataConflict"];
